...
class Get_Dataset():
    ...
    def get_features(self):
        ...
        self.x1 = util.prepare_trees(self.x1, self.transformer, self.left_child, self.right_child, cuda=False, device=None)
        self.x2 = util.prepare_trees(self.x2, self.transformer, self.left_child, self.right_child, cuda=False, device=None)
...
class Get_Dataset_Test():
    ...
    def load_model(self, path,uncertainty = False):
